...
Source0  : https://github.com/sailfishos/libglibutil/archive/1.0.80/libglibutil-1.0.80.tar.gz
...
%prep
%setup -q -n libglibutil-1.0.80
cd %{_builddir}/libglibutil-1.0.80
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746556156
...
cp %{_builddir}/libglibutil-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/libglibutil/dd5989a552a92a5be4e2ab45fcc36eb264d68857 || :
cp %{_builddir}/libglibutil-%{version}/debian/copyright %{buildroot}/usr/share/package-licenses/libglibutil/dd5989a552a92a5be4e2ab45fcc36eb264d68857 || :
export GOAMD64=v2
GOAMD64=v2
...
/usr/lib64/libglibutil.so.1.0.80

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libglibutil/dd5989a552a92a5be4e2ab45fcc36eb264d68857
